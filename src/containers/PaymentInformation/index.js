...
handleSubmit =async () => {
  ...
  const { actions:{ setShippingDetails } ,navigation:{ navigate } } = this.props
...
handleSubmitWithLocation=async () => {
  ...
  Geolocation.getCurrentPosition((result) => {
    ...
    setShippingDetails({
      receiverName,city,phoneNumber,street,lat:latitude,lng:longitude,
    }).then(() => {
      navigate('Payment')
    })
