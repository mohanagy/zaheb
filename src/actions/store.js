...
export const updateCoordinates = value => async dispatch => {
  dispatch(getDataSuccess({ coordinates: value }))
}
export const skippedWorkShop = value => async dispatch => {
  dispatch(getDataSuccess({ skippedWorkShop: value }))
}
export const selectNewService = value => async dispatch => {
  dispatch(getDataSuccess({ newServiceId: value }))
}
...
export const getWorkShopsByServiceId = id => async (dispatch, getState) => {
  ...
  try {
    const response = await fetch(
      `${api.getWorkshopsByServiceId}?service_id=${id}`,
      {
        method: 'GET',
        headers: {
          Accept: 'application/json',
...
export const getServicesByCarId = id => async (dispatch, getState) => {
  ...
  try {
    const response = await fetch(
      `${api.getServicesClassificationByCarTypeId}?car_id=${id}`,
      {
        method: 'GET',
        headers: {
          Accept: 'application/json',
...
export const getProductsClassification = id => async (dispatch, getState) => {
  ...
  try {
    const response = await fetch(
      `${api.getProductsClassificationByCarTypeId}?car_id=${id}`,
      {
        method: 'GET',
        headers: {
          Accept: 'application/json',
  ...
  try {
    const url =
      driver_type === 'supplier'
        ? api.getDriverActiveProductOrders
        : api.getDriverActiveServiceOrders
...
export const getMyDriverOrders = () => async (dispatch, getState) => {
  ...
  try {
    const url =
      driver_type === 'supplier'
        ? api.getDriverAcceptedProductOrder
        : api.getDriverAcceptedServiceOrder
    const response = await fetch(url, {
      method: 'GET',
      headers: {
        Accept: 'application/json',
...
export const getServiceByWorkshopsId = (workshop_id,type_of_car_id,service_classification_of_car_id) => async (dispatch, getState) => {
  dispatch(startStoreFetching())
  try {
    const {
      userData: { accessToken },
    } = getState()
    const response = await fetch(`${api.getServiceByWorkshopsId}workshop_id=${workshop_id}&type_of_car_id=${type_of_car_id}&service_classification_of_car_id=${service_classification_of_car_id}`, {
      method: 'GET',
      headers: {
        Accept: 'application/json',
        Authorization: `Bearer ${accessToken}`,
    ...
    const json = await response.json()
    const { serviceByIdWorkshops } = json
    dispatch(getDataSuccess({ serviceByIdWorkshops }))
  } catch (error) {
...
export const handleAcceptOrder = id => async (dispatch, getState) => {
  ...
  try {
    ...
    const url =
      driver_type === 'supplier'
        ? api.acceptProductOrder
        : api.acceptServiceOrder
...
export const getAvailableOrderById = id => async (dispatch, getState) => {
  ...
  try {
    ...
    const response = await fetch(
      `${api.getDriverActiveProductOrderByProductOrderId}${id}`,
      {
        method: 'GET',
        headers: {
          Accept: 'application/json',
...
export const getMyOrderByOrderId = id => async (dispatch, getState) => {
  ...
  try {
    ...
    const response = await fetch(
      `${api.getDriverActiveServiceOrderByServiceOrderId}${id}`,
      {
        method: 'GET',
        headers: {
          Accept: 'application/json',
...
export const changeOrderStatus = (status,orderId) => async (dispatch, getState) => {
  dispatch(startStoreFetching())
  try {
    const {
      userData: { accessToken },
...
export const getProductsByFilters = productsFilter => async (
  dispatch,
  getState
) => {
  dispatch(startStoreFetching())
...
export const placeOrder = newOrder => async (dispatch, getState) => {
  ...
  try {
    ...
    data.append('lat', newOrder.lat ||  '1')
    data.append('lng', newOrder.lng ||  '1')
    ...
    dispatch(
      errorHappened({
        type: 'error',
        title: 'Error',
        message: error.message || 'حدث خطأ ما يرجى التأكد من اتصالك بالانترنت',
      })
    )
    return false
  } finally {
