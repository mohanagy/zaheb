...
export const AvailableOrderCard = ({
    ...
    <Group style={{ flex: 1, marginHorizontal: 6 }}>
      ...
      >
        ...
        <Group style={{ justifyContent: 'space-between', alignItems: 'flex-end', marginVertical: 10 }}>
          <SplashButton title="accept" style={buttonStyle} onPress={handleAccept} />
          <SplashButton title="cancel" style={buttonStyle} onPress={handleCancel} />
        </Group>
      </Group>
    </Group>
  </Group>
